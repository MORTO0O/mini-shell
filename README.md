...
| Команда                 | Назначение                                                                                                                    |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **ls [path] [-l]**      | Отображение списка файлов и каталогов в указанном или текущем каталоге. Опция `-l` — подробный вывод (права, размер, дата).   |
...
| **history [n]**         | Вывод последних `n` команд из истории.                                                                                        |
...
| **undo**                            | Отмена последнего действия (`cp`, `mv`, `rm`).                                                                                |
---
...
3. **Логирование** всех команд и ошибок в файл `shell.log` (в домашнем каталоге пользователя).
   Формат лога:
   ```
   [2025-10-01 13:45:22] ls -l /home/user
...
6. Команды `cp`, `mv`, `rm` создают записи для возможного отката.
